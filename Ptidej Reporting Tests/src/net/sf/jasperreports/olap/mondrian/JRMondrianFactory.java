 ...
 * @version $Id: JRMondrianFactory.java,v 1.1 2008/09/29 16:20:50 guehene Exp $
 */
public class JRMondrianFactory
{
	...
	public JRMondrianMember createMember(Member member)
	{
		...
		else
		{
			...
			mondrianMember = (JRMondrianMember) this.members.get(key);
			if (mondrianMember == null)
			{
				mondrianMember = new JRMondrianMember(member, this);
				this.members.put(key, mondrianMember);
			}
		}
