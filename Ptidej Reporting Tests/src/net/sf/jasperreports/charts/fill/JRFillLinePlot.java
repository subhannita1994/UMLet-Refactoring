 ...
 * @version $Id: JRFillLinePlot.java,v 1.1 2008/09/29 16:21:42 guehene Exp $
 */
public class JRFillLinePlot extends JRFillChartPlot implements JRLinePlot 
{
	...
	public JRFillLinePlot( JRLinePlot plot, JRFillObjectFactory factory )
	{
		...
		this.categoryAxisLabelFont = new JRBaseFont(null, null, plot.getChart(), plot.getCategoryAxisLabelFont()); 
		this.categoryAxisLabelColor = plot.getOwnCategoryAxisLabelColor();
		this.categoryAxisTickLabelFont = new JRBaseFont(null, null, plot.getChart(), plot.getCategoryAxisTickLabelFont());
