 ...
 * @version $Id: JRDesignThermometerPlot.java,v 1.1 2008/09/29 16:21:32 guehene Exp $
 */
public class JRDesignThermometerPlot extends JRBaseThermometerPlot
{
	...
	public void setValueLocation(byte valueLocation)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_VALUE_LOCATION, (float) old, (float) this.valueLocation);
	}
