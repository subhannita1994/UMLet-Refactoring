 ...
 * @version $Id: JRDesignMultiAxisPlot.java,v 1.1 2008/09/29 16:21:32 guehene Exp $
 */
public class JRDesignMultiAxisPlot extends JRBaseMultiAxisPlot
{
	...
	public void addAxis(JRChartAxis axis)
	{
		...
		getEventSupport().fireCollectionElementAddedEvent(PROPERTY_AXES, axis, this.axes.size() - 1);
	}
