 ...
 * @version $Id: XYZElement.java,v 1.1 2008/09/29 16:21:44 guehene Exp $
 */
public class XYZElement implements Serializable {
	...
	public Number getXElement( int index ){
		return (Number)this.xElements.get( index );
	}
	
	public Number getYElement( int index ){
		return (Number)this.yElements.get( index );
	}
	
	public Number getZElement( int index ){
		return (Number)this.zElements.get( index );
	}
