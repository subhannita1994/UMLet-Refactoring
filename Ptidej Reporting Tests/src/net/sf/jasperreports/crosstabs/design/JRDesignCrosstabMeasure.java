 ...
 * @version $Id: JRDesignCrosstabMeasure.java,v 1.1 2008/09/29 16:21:17 guehene Exp $
 */
public class JRDesignCrosstabMeasure extends JRBaseCrosstabMeasure implements JRChangeEventsSupport
{
	...
	public JRDesignCrosstabMeasure()
	{
		...
		this.variable = this.designVariable = new JRDesignVariable();
		this.designVariable.setCalculation(JRVariable.CALCULATION_SYSTEM);
	...
	public void setCalculation(byte calculation)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_CALCULATION, (float) old, (float) this.calculation);
	}
	...
	public void setPercentageOfType(byte percentageOfType)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_PERCENTAGE_OF_TYPE, (float) old, (float) this.percentageOfType);
	}
