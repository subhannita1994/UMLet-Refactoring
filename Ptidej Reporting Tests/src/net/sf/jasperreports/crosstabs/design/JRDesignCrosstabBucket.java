 ...
 * @version $Id: JRDesignCrosstabBucket.java,v 1.1 2008/09/29 16:21:17 guehene Exp $
 */
public class JRDesignCrosstabBucket extends JRBaseCrosstabBucket implements JRChangeEventsSupport
{
	...
	public void setOrder(byte order)
	{
		byte old = this.order;
		this.order = order;
		getEventSupport().firePropertyChange(PROPERTY_ORDER, (float) old, (float) this.order);
	}
