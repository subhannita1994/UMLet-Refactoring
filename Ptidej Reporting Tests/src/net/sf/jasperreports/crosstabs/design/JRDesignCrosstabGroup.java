 ...
 * @version $Id: JRDesignCrosstabGroup.java,v 1.1 2008/09/29 16:21:17 guehene Exp $
 */
public abstract class JRDesignCrosstabGroup extends JRBaseCrosstabGroup implements JRChangeEventsSupport
{
	...
	public void setTotalPosition(byte totalPosition)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_TOTAL_POSITION, (float) old, (float) this.totalPosition);
	}
