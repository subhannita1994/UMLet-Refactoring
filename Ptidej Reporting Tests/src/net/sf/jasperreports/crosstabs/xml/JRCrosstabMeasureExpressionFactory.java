 ...
 * @version $Id: JRCrosstabMeasureExpressionFactory.java,v 1.1 2008/09/29 16:21:55 guehene Exp $
 */
public class JRCrosstabMeasureExpressionFactory extends JRBaseFactory
{
	public Object createObject(Attributes attributes)
	{
		JRDesignCrosstabMeasure measure = (JRDesignCrosstabMeasure) this.digester.peek();
