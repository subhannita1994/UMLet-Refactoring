 ...
 * @version $Id: JRCrosstabParameterValueExpressionFactory.java,v 1.1 2008/09/29 16:21:54 guehene Exp $
 */
public class JRCrosstabParameterValueExpressionFactory extends JRBaseFactory
{
	public Object createObject(Attributes atts)
	{
		JRDesignParameter parameter = (JRDesignParameter)this.digester.peek();
