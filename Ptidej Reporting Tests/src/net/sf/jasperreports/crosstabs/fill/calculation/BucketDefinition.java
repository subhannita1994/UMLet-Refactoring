 ...
 * @version $Id: BucketDefinition.java,v 1.1 2008/09/29 16:21:53 guehene Exp $
 */
...
{	
	...
	public BucketDefinition(Class valueClass, Comparator comparator, byte order, byte totalPosition) throws JRException
	{
		...
		this.computeTotal = totalPosition != TOTAL_POSITION_NONE;
	}
	...
	public class Bucket implements Comparable
	{
		...
		public boolean equals (Object o)
		{
			...
			if (this.type != VALUE_TYPE_VALUE)
			{
				return this.type == v.type;
			}
			
			return v.type == VALUE_TYPE_VALUE && this.value.equals(v.value);
		}
		...
		{
			return this.type == VALUE_TYPE_TOTAL;
		}
	}
}
