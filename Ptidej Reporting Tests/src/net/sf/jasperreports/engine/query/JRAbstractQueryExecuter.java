 ...
 * @version $Id: JRAbstractQueryExecuter.java,v 1.1 2008/09/29 16:20:33 guehene Exp $
 */
public abstract class JRAbstractQueryExecuter implements JRQueryExecuter
{
	...
	protected static class QueryParameter
	{
		...
		{
			return this.count != COUNT_SINGLE;
		}
	...
	{
		List parameterNames = new ArrayList(this.queryParameters.size());
		for (Iterator it = this.queryParameters.iterator(); it.hasNext();)
		{
