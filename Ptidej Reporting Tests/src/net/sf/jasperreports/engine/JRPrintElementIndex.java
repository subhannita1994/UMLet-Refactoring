 ...
 * @version $Id: JRPrintElementIndex.java,v 1.1 2008/09/29 16:20:42 guehene Exp $
 */
public class JRPrintElementIndex
{
	...
	public String toString()
	{
		...
		str.append(this.reportIndex);
		str.append('_');
		str.append(this.pageIndex);
		str.append('_');
	...
	{
		StringTokenizer tkzer = new StringTokenizer(this.address, "_");
