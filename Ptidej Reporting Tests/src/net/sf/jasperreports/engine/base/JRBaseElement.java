 ...
 * @version $Id: JRBaseElement.java,v 1.1 2008/09/29 16:21:16 guehene Exp $
 */
public abstract class JRBaseElement implements JRElement, Serializable, JRChangeEventsSupport
{
	...
	public void setPositionType(byte positionType)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_POSITION_TYPE, (float) old, (float) this.positionType);
	}
	...
	public void setStretchType(byte stretchType)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_STRETCH_TYPE, (float) old, (float) this.stretchType);
	}
	...
	public void setX(int x)
	{
		int old = this.x;
		this.x = x;
		getEventSupport().firePropertyChange(PROPERTY_X, (float) old, (float) this.x);
	}
	...
	public void setWidth(int width)
	{
		int old = this.width;
		this.width = width;
		getEventSupport().firePropertyChange(PROPERTY_WIDTH, (float) old, (float) this.width);
	}
