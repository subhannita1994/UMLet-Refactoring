 ...
 * @version $Id: JRBaseGroup.java,v 1.1 2008/09/29 16:21:16 guehene Exp $
 */
public class JRBaseGroup implements JRGroup, Serializable, JRChangeEventsSupport
{
	...
	public void setMinHeightToStartNewPage(int minHeight)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_MIN_HEIGHT_TO_START_NEW_PAGE, (float) old, (float) this.minHeightToStartNewPage);
	}
