 ...
 * @version $Id: JRPrintHyperlinkParameterValueFactory.java,v 1.1 2008/09/29 16:19:52 guehene Exp $
...
public class JRPrintHyperlinkParameterValueFactory extends JRBaseFactory
{
	...
	{
		JRPrintHyperlinkParameter parameter = (JRPrintHyperlinkParameter) this.digester.peek();
	...
	public static class JRPrintHyperlinkParameterValue
	{
		...
		public void setData(String data)
		{
			if (data != null)
			{
				Object value = JRValueStringUtils.deserialize(this.parameter.getValueClass(), data);
