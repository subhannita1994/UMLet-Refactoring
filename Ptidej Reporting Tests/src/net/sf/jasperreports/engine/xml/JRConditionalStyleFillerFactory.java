 ...
 * @version $Id: JRConditionalStyleFillerFactory.java,v 1.1 2008/09/29 16:19:52 guehene Exp $
 */
public class JRConditionalStyleFillerFactory extends JRBaseFactory
{
	...
	{
		JRDesignConditionalStyle style = (JRDesignConditionalStyle) this.digester.peek();
