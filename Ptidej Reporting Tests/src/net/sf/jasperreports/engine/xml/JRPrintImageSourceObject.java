 ...
 * @version $Id: JRPrintImageSourceObject.java,v 1.1 2008/09/29 16:19:52 guehene Exp $
 */
	...
	public void setImageSource(String imageSource) throws JRException
	{
		if (this.isEmbedded)
		{
			try
			{
				...
				this.printImage.setRenderer(JRImageRenderer.getInstance(baos.toByteArray()));//, JRImage.ON_ERROR_TYPE_ERROR));
			}
			catch (Exception e)
			{
