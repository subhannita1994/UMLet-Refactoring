 ...
 * @version $Id: JRPrintElementFactory.java,v 1.1 2008/09/29 16:19:53 guehene Exp $
 */
public class JRPrintElementFactory extends JRBaseFactory
{
	...
	{
		JRPrintXmlLoader printXmlLoader = (JRPrintXmlLoader)this.digester.peek(this.digester.getCount() - 1);
		JasperPrint jasperPrint = (JasperPrint)this.digester.peek(this.digester.getCount() - 2);
		JRBasePrintElement element = (JRBasePrintElement)this.digester.peek();
