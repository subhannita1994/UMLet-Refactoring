 ...
 * @version $Id: JRTemplateStyleFactory.java,v 1.1 2008/09/29 16:19:53 guehene Exp $
 */
public class JRTemplateStyleFactory extends JRAbstractStyleFactory
{
	...
	{
		JRSimpleTemplate template = (JRSimpleTemplate) this.digester.peek(this.digester.getCount() - 1);
