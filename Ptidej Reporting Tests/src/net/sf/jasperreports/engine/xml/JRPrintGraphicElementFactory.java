 ...
 * @version $Id: JRPrintGraphicElementFactory.java,v 1.1 2008/09/29 16:19:53 guehene Exp $
 */
public class JRPrintGraphicElementFactory extends JRBaseFactory
{
	...
	{
		JRBasePrintGraphicElement graphicElement = (JRBasePrintGraphicElement)this.digester.peek();
