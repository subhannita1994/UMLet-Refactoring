 ...
 * @version $Id: JROriginExporterFilter.java,v 1.1 2008/09/29 16:20:46 guehene Exp $
 */
public class JROriginExporterFilter implements ResetableExporterFilter
{
	...
	public boolean isToExport(JRPrintElement element)
	{
		...
		Boolean keepFirst = (origin == null ? null : (Boolean)this.originsToExclude.get(origin));
	...
	private boolean isFirst(JRTemplatePrintElement element)
	{
		...
		Object firstElement = this.firstOccurrences.get(template);
		if (firstElement == null || firstElement == element)
		{
			this.firstOccurrences.put(template, element);
			return true;
		}
		return false;
	}
