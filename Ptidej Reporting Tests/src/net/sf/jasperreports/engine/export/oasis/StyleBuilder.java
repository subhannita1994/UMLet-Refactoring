 ...
 * @version $Id: StyleBuilder.java,v 1.1 2008/09/29 16:19:59 guehene Exp $
 */
public class StyleBuilder
{
	...
	private void buildBeforeAutomaticStyles() throws IOException
	{
		...
		this.writer.write(ContentBuilder.VERSION);		
		this.writer.write("\">\n");		
	...
	private void buildPageLayout(int reportIndex, JasperPrint jasperPrint) throws IOException 
	{
			...
			this.writer.write(" fo:page-width=\"" + Utility.translatePixelsToInchesRound(jasperPrint.getPageWidth()) +"in\"");
			this.writer.write(" fo:page-height=\"" + Utility.translatePixelsToInchesRound(jasperPrint.getPageHeight()) +"in\"");//FIXMEODT we probably need some actualHeight trick
