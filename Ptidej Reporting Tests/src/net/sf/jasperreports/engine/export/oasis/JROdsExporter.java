 ...
 * @version $Id: JROdsExporter.java,v 1.1 2008/09/29 16:20:00 guehene Exp $
 */
public class JROdsExporter extends JROpenDocumentExporter
{
	...
	{
		super();
		this.exporterPropertiesPrefix = JROpenDocumentExporter.ODS_EXPORTER_PROPERTIES_PREFIX;
	}
