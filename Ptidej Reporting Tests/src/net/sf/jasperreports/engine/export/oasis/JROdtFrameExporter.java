 ...
 * @version $Id: JROdtFrameExporter.java,v 1.1 2008/09/29 16:20:00 guehene Exp $
 */
public class JROdtFrameExporter extends JRAbstractExporter
{
	...
	protected void exportLine(JRPrintLine line) throws IOException
	{
		this.tempBodyWriter.write(
			...
			+ " text:anchor-page-number=\"" + (this.pageIndex + 1) + "\""
...
//		boolean startedHyperlink = startHyperlink(text);
		...
		this.tempBodyWriter.write(
			...
			+ " text:anchor-page-number=\"" + (this.pageIndex + 1) + "\""
			+ " draw:style-name=\"" + this.styleCache.getFrameStyle(text) + "\""
