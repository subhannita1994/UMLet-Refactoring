 ...
 * @version $Id: ParagraphStyle.java,v 1.1 2008/09/29 16:20:00 guehene Exp $
 */
public class ParagraphStyle extends Style
{
	...
	*/
	...
	public ParagraphStyle(Writer styleWriter, JRPrintText text)
	{
		...
		this.horizontalAlignment = getHorizontalAlignment(text.getHorizontalAlignment(), text.getVerticalAlignment(), text.getRotation());
		this.verticalAlignment = getVerticalAlignment(text.getHorizontalAlignment(), text.getVerticalAlignment(), text.getRotation());
