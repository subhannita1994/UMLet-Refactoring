 ...
 * @version $Id: JRHyperlinkProducerMapFactory.java,v 1.1 2008/09/29 16:20:46 guehene Exp $
 */
public class JRHyperlinkProducerMapFactory extends JRHyperlinkProducerFactory implements Serializable
{
	...
	{
		this.producers.put(linkType, producer);
	}
	...
	{
		return (JRHyperlinkProducer) this.producers.remove(linkType);
	}
	
	
	public JRHyperlinkProducer getHandler(String linkType)
	{
		return (JRHyperlinkProducer) this.producers.get(linkType);
	}
