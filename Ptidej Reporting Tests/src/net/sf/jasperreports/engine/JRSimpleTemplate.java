 ...
 * @version $Id: JRSimpleTemplate.java,v 1.1 2008/09/29 16:20:42 guehene Exp $
 */
public class JRSimpleTemplate implements JRTemplate, Serializable
{
	...
	public JRStyle removeStyle(String name)
	{
		...
		for (ListIterator it = this.styles.listIterator(); it.hasNext();)
		{
	...
	public JRTemplateReference removeIncludedTemplate(String location)
	{
		...
		for (ListIterator it = this.includedTemplates.listIterator(); it.hasNext();)
		{
