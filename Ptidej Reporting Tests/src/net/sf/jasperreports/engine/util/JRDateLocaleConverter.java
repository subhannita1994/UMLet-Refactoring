 ...
 * @author szaharia
 * @version $Id: JRDateLocaleConverter.java,v 1.1 2008/09/29 16:20:17 guehene Exp $
 */
...
public class JRDateLocaleConverter extends DateLocaleConverter 
{
	...
	{
		SimpleDateFormat formatter = getFormatter(pattern, this.locale);
		if (pattern != null)
		{
			if (this.locPattern) {
