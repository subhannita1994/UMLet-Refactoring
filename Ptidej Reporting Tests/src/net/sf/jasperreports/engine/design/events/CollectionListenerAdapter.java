 ...
 * @version $Id: CollectionListenerAdapter.java,v 1.1 2008/09/29 16:22:07 guehene Exp $
 */
public class CollectionListenerAdapter implements PropertyChangeListener
{
	...
	public void propertyChange(PropertyChangeEvent evt)
	{
		...
		{
			this.listener.collectionElementAdded((CollectionElementAddedEvent) evt);
		}
		else if (evt instanceof CollectionElementRemovedEvent)
		{
			this.listener.collectionElementRemoved((CollectionElementRemovedEvent) evt);
		}
	}
