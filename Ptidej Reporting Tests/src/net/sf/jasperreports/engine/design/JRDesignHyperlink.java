 ...
 * @version $Id: JRDesignHyperlink.java,v 1.1 2008/09/29 16:20:08 guehene Exp $
 */
public class JRDesignHyperlink extends JRBaseHyperlink implements JRChangeEventsSupport
{
	...
	public void setHyperlinkTarget(byte hyperlinkTarget)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_HYPERLINK_TARGET, (float) old, (float) this.hyperlinkTarget);
	}
