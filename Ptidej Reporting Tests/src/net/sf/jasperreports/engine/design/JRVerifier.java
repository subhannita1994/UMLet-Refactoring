 ...
 * @version $Id: JRVerifier.java,v 1.1 2008/09/29 16:20:08 guehene Exp $
 */
public class JRVerifier
{
	...
	protected JRVerifier(JasperDesign jrDesign, JRExpressionCollector expressionCollector)
	{
		...
		{
			this.expressionCollector = JRExpressionCollector.collector(this.jasperDesign);
		}
	}
	...
	{
		/*   */
		this.jasperDesign.preprocess();//FIXME either calculate twice or use change listeners
	...
	private void verifyDesignAttributes()
	{
		...
		if (
			this.jasperDesign.getLeftMargin() +
			this.jasperDesign.getColumnCount() * this.jasperDesign.getColumnWidth() +
			(this.jasperDesign.getColumnCount() - 1) * this.jasperDesign.getColumnSpacing() +
			this.jasperDesign.getRightMargin() >
			this.jasperDesign.getPageWidth()
			)
		{
		...
		if (
			this.jasperDesign.getTopMargin() +
			(this.jasperDesign.getBackground() != null ? this.jasperDesign.getBackground().getHeight() : 0) +
			this.jasperDesign.getBottomMargin() >
			this.jasperDesign.getPageHeight()
			)
		{
			addBrokenRule("The background section and the margins do not fit the page height.", this.jasperDesign);
		}
		...
		if (this.jasperDesign.isTitleNewPage())
		{
			if (
				this.jasperDesign.getTopMargin() +
				(this.jasperDesign.getTitle() != null ? this.jasperDesign.getTitle().getHeight() : 0) +
				this.jasperDesign.getBottomMargin() >
				this.jasperDesign.getPageHeight()
				)
			{
				addBrokenRule("The title section and the margins do not fit the page height.", this.jasperDesign);
			}
		}
		else
		{
			if (
				this.jasperDesign.getTopMargin() +
				(this.jasperDesign.getTitle() != null ? this.jasperDesign.getTitle().getHeight() : 0) +
				(this.jasperDesign.getPageHeader() != null ? this.jasperDesign.getPageHeader().getHeight() : 0) +
				(this.jasperDesign.getColumnHeader() != null ? this.jasperDesign.getColumnHeader().getHeight() : 0) +
				(this.jasperDesign.getColumnFooter() != null ? this.jasperDesign.getColumnFooter().getHeight() : 0) +
				(this.jasperDesign.getPageFooter() != null ? this.jasperDesign.getPageFooter().getHeight() : 0) +
				this.jasperDesign.getBottomMargin() >
				this.jasperDesign.getPageHeight()
				)
			{
				addBrokenRule("The title section, the page and column headers and footers and the margins do not fit the page height.", this.jasperDesign);
			}
		}
		...
		{
			addBrokenRule("The page and column headers and footers and the margins do not fit the page height.", this.jasperDesign);
		}
		...
		if (
			...
			(this.jasperDesign.getColumnHeader() != null ? this.jasperDesign.getColumnHeader().getHeight() : 0) +
			(this.jasperDesign.getColumnFooter() != null ? this.jasperDesign.getColumnFooter().getHeight() : 0) +
			(this.jasperDesign.getLastPageFooter() != null ? this.jasperDesign.getLastPageFooter().getHeight() : 0) +
			this.jasperDesign.getBottomMargin() >
			this.jasperDesign.getPageHeight()
			)
		{
			addBrokenRule("The page and column headers and footers and the margins do not fit the last page height.", this.jasperDesign);
		}

		if (
			this.jasperDesign.getTopMargin() +
			(this.jasperDesign.getSummary() != null ? this.jasperDesign.getSummary().getHeight() : 0) +
			this.jasperDesign.getBottomMargin() >
			this.jasperDesign.getPageHeight()
			)
		{
			addBrokenRule("The summary section and the margins do not fit the page height.", this.jasperDesign);
		}
		...
		if (
			...
			(this.jasperDesign.getPageHeader() != null ? this.jasperDesign.getPageHeader().getHeight() : 0) +
			(this.jasperDesign.getColumnHeader() != null ? this.jasperDesign.getColumnHeader().getHeight() : 0) +
			(this.jasperDesign.getDetail() != null ? this.jasperDesign.getDetail().getHeight() : 0) +
			(this.jasperDesign.getColumnFooter() != null ? this.jasperDesign.getColumnFooter().getHeight() : 0) +
			(this.jasperDesign.getPageFooter() != null ? this.jasperDesign.getPageFooter().getHeight() : 0) +
			this.jasperDesign.getBottomMargin() >
			this.jasperDesign.getPageHeight()
		...
		{
			addBrokenRule("The detail section, the page and column headers and footers and the margins do not fit the page height.", this.jasperDesign);
		}

		if (
				this.jasperDesign.getTopMargin() +
				(this.jasperDesign.getNoData() != null ? this.jasperDesign.getNoData().getHeight() : 0) +
				this.jasperDesign.getBottomMargin() >
				this.jasperDesign.getPageHeight()
				)
		{
			addBrokenRule("The noData section and the margins do not fit the page height.", this.jasperDesign);
		}
	...
	{
		verifyExpressions(
				this.expressionCollector.getExpressions(dataset),
...
//								);
	...
	private void verifyFont(JRFont font)
	{
		...
		{
			Map fontsMap = this.jasperDesign.getFontsMap();
	...
	{
		verifyExpressions(this.expressionCollector.getExpressions(crosstab),
