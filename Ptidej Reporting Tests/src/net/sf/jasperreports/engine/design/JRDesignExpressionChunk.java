 ...
 * @version $Id: JRDesignExpressionChunk.java,v 1.1 2008/09/29 16:20:08 guehene Exp $
 */
public class JRDesignExpressionChunk extends JRBaseExpressionChunk implements JRChangeEventsSupport
{
	...
	public void setType(byte type)
	{
		byte old = this.type;
		this.type = type;
		getEventSupport().firePropertyChange(PROPERTY_TYPE, (float) old, (float) this.type);
	}
