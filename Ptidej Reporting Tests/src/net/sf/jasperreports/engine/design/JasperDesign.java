 ...
 * @version $Id: JasperDesign.java,v 1.1 2008/09/29 16:20:08 guehene Exp $
 */
public class JasperDesign extends JRBaseReport
{
	...
	public void setColumnCount(int columnCount)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_COLUMN_COUNT, (float) old, (float) this.columnCount);
	}
	...
	public void setPrintOrder(byte printOrder)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_PRINT_ORDER, (float) old, (float) this.printOrder);
	}
	...
	public void setPageWidth(int pageWidth)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_PAGE_WIDTH, (float) old, (float) this.pageWidth);
	}
	...
	public void setPageHeight(int pageHeight)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_PAGE_HEIGHT, (float) old, (float) this.pageHeight);
	}
	...
	public void setOrientation(byte orientation)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_ORIENTATION, (float) old, (float) this.orientation);
	}
	...
	public void setColumnWidth(int columnWidth)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_COLUMN_WIDTH, (float) old, (float) this.columnWidth);
	}
	...
	public void setColumnSpacing(int columnSpacing)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_COLUMN_SPACING, (float) old, (float) this.columnSpacing);
	}
	...
	public void setLeftMargin(int leftMargin)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_LEFT_MARGIN, (float) old, (float) this.leftMargin);
	}
	...
	public void setRightMargin(int rightMargin)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_RIGHT_MARGIN, (float) old, (float) this.rightMargin);
	}
	...
	public void setTopMargin(int topMargin)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_TOP_MARGIN, (float) old, (float) this.topMargin);
	}
	...
	public void setBottomMargin(int bottomMargin)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_BOTTOM_MARGIN, (float) old, (float) this.bottomMargin);
	}
	...
	public void addImport(String value)
	{
		...
		{
			getEventSupport().fireCollectionElementAddedEvent(PROPERTY_IMPORTS, value, this.importsSet.size() - 1);
		}
	}
	...
	public void addFont(JRReportFont reportFont) throws JRException
	{
		...
		getEventSupport().fireCollectionElementAddedEvent(PROPERTY_FONTS, reportFont, this.fontsList.size() - 1);
	}
	...
	{
		return removeFont(
			(JRReportFont)this.fontsMap.get(propName)
			);
	}
	...
	public void addStyle(JRStyle style) throws JRException
	{
		...
		getEventSupport().fireCollectionElementAddedEvent(PROPERTY_STYLES, style, this.stylesList.size() - 1);
	}
	...
	public void addDataset(JRDesignDataset dataset) throws JRException
	{
		...
		getEventSupport().fireCollectionElementAddedEvent(PROPERTY_DATASETS, dataset, this.datasetList.size() - 1);
	}
	...
	public JRDataset removeDataset(String datasetName)
	{
		return removeDataset(
			(JRDataset)this.datasetMap.get(datasetName)
			);
	}
	...
	public void addTemplate(JRReportTemplate template)
	{
		...
		getEventSupport().fireCollectionElementAddedEvent(PROPERTY_TEMPLATES, template, this.templateList.size() - 1);
	}
