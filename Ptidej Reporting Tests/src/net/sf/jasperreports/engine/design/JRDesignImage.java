 ...
 * @version $Id: JRDesignImage.java,v 1.1 2008/09/29 16:20:08 guehene Exp $
 */
public class JRDesignImage extends JRDesignGraphicElement implements JRImage
{
	...
	public void setOnErrorType(byte onErrorType)
	{
		...
		getEventSupport().firePropertyChange(JRBaseImage.PROPERTY_ON_ERROR_TYPE, (float) old, (float) this.onErrorType);
	}
