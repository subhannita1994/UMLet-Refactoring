 ...
 * @version $Id: JRDesignLine.java,v 1.1 2008/09/29 16:20:08 guehene Exp $
 */
public class JRDesignLine extends JRDesignGraphicElement implements JRLine
{
	...
	public void setDirection(byte direction)
	{
		...
		getEventSupport().firePropertyChange(JRBaseLine.PROPERTY_DIRECTION, (float) old, (float) this.direction);
	}
