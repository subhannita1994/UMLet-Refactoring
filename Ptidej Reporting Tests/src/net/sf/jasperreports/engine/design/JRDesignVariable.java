 ...
 * @version $Id: JRDesignVariable.java,v 1.1 2008/09/29 16:20:08 guehene Exp $
 */
public class JRDesignVariable extends JRBaseVariable implements JRChangeEventsSupport
{
	...
	public void setResetType(byte resetType)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_RESET_TYPE, (float) old, (float) this.resetType);
	}
	...
	public void setIncrementType(byte incrementType)
	{
		...
		getEventSupport().firePropertyChange(PROPERTY_INCREMENT_TYPE, (float) old, (float) this.incrementType);
	}
