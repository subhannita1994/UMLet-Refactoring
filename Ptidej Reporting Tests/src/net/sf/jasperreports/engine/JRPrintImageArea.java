 ...
 * @version $Id: JRPrintImageArea.java,v 1.1 2008/09/29 16:20:42 guehene Exp $
...
public class JRPrintImageArea implements Serializable
{
	...
	{
		return this.shape != SHAPE_DEFAULT;
	}
	...
	protected Shape createAWTRectangle()
	{
		...
		return new Rectangle(
				this.coordinates[0], 
				this.coordinates[1], 
				this.coordinates[2] - this.coordinates[0],
				this.coordinates[3] - this.coordinates[1]);
	}
