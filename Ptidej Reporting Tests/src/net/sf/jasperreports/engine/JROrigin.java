 ...
 * @version $Id: JROrigin.java,v 1.1 2008/09/29 16:20:43 guehene Exp $
 */
public class JROrigin implements JRCloneable, Serializable
{
	...
	public boolean equals(Object obj) 
	{
		if (obj instanceof JROrigin)
		{
			...
			return
				origin.getBandType() == this.bandType
				&& ((this.groupName == null && groupName2 == null) || (this.groupName.equals(groupName2)))
				&& ((this.reportName == null && reportName2 == null) || (this.reportName.equals(reportName2)));
		}
		return false;
	}
