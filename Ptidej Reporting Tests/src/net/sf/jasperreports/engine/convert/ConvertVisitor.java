 ...
 * @version $Id: ConvertVisitor.java,v 1.1 2008/09/29 16:20:07 guehene Exp $
 */
public class ConvertVisitor implements JRVisitor
{
	...
	public void visitChart(JRChart chart)
	{
		...
		addElement(this.parentFrame, printImage);
		addContour(this.reportConverter, this.parentFrame, printImage);
	}
	...
	public void visitCrosstab(JRCrosstab crosstab)
	{
		...
		addElement(this.parentFrame, printFrame);
		addContour(this.reportConverter, this.parentFrame, printFrame);
	}
	...
	{
		addElement(this.parentFrame, EllipseConverter.getInstance().convert(this.reportConverter, ellipse));
	}
	...
	{
		addElement(this.parentFrame, LineConverter.getInstance().convert(this.reportConverter, line));
	}
	...
	{
		addElement(this.parentFrame, RectangleConverter.getInstance().convert(this.reportConverter, rectangle));
	}
	...
	public void visitStaticText(JRStaticText staticText)
	{
		...
		addElement(this.parentFrame, printText);
		addContour(this.reportConverter, this.parentFrame, printText);
	}
