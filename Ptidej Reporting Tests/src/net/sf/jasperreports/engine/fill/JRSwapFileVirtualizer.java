 ...
 * @version $Id: JRSwapFileVirtualizer.java,v 1.1 2008/09/29 16:20:00 guehene Exp $
 */
public class JRSwapFileVirtualizer extends JRAbstractLRUVirtualizer
{
	...
	{
		if (!this.handles.containsKey(o.getUID()))
		{
	...
	{
		JRSwapFile.SwapHandle handle = (JRSwapFile.SwapHandle) this.handles.get(o.getUID());
		byte[] data = this.swap.read(handle, !isReadOnly(o));
