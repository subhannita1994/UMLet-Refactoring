 ...
 * @version $Id: JRThreadSubreportRunner.java,v 1.1 2008/09/29 16:20:01 guehene Exp $
 */
public class JRThreadSubreportRunner extends JRSubreportRunnable implements JRSubreportRunner
{
	...
	protected JRSubreportRunResult waitResult()
	{
		...
		try
		{
			...
			this.subreportFiller.wait(); // FIXME maybe this is useless since you cannot enter 
