 ...
 * @version $Id: JRFillReportTemplate.java,v 1.1 2008/09/29 16:20:01 guehene Exp $
 */
public class JRFillReportTemplate implements JRReportTemplate
{
	...
	public JRTemplate evaluate() throws JRException
	{
		...
		Object source = this.filler.evaluateExpression(sourceExpression, JRExpression.EVALUATION_DEFAULT);
		if (source == null)
		{
			template = null;
		}
