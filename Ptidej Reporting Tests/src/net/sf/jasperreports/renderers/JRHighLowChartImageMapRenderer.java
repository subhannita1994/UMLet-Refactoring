 ...
 * @version $Id: JRHighLowChartImageMapRenderer.java,v 1.1 2008/09/29 16:22:00 guehene Exp $
 */
public class JRHighLowChartImageMapRenderer extends JRAbstractChartImageMapRenderer
{
	...
	{
		return this.highLowChartHyperlinkProvider.getEntityHyperlink(entity);
	}

	public boolean hasHyperlinks()
	{
		return this.highLowChartHyperlinkProvider.hasHyperlinks();
	}
	...
	private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException
	{
		...
		if (this.highLowChartHyperlinkProvider == null)
		{
			this.highLowChartHyperlinkProvider = new HighLowChartHyperlinkProvider(this.itemHyperlinks);
