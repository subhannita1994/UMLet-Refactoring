 ...
 * @version $Id: BatikRenderer.java,v 1.1 2008/09/29 16:22:00 guehene Exp $
 */
public class BatikRenderer extends JRAbstractSvgRenderer implements JRImageMapRenderer
{
		...
		try
		{
    		...
    		if (this.svgText != null)
    		{
    			document = documentFactory.createSVGDocument("", 
    	        		new StringReader(this.svgText));
    		}
    		else
    		{
    			document = documentFactory.createSVGDocument("", 
    					new ByteArrayInputStream(this.svgData));
    		}
	...
	{
		if (this.svgText == null
				&& this.svgData == null && this.svgDataLocation != null)
		{
