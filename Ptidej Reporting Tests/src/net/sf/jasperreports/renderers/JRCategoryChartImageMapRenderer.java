 ...
 * @version $Id: JRCategoryChartImageMapRenderer.java,v 1.1 2008/09/29 16:22:00 guehene Exp $
 */
public class JRCategoryChartImageMapRenderer extends JRAbstractChartImageMapRenderer
{
	...
	{
		return this.categoryChartHyperlinkProvider.getEntityHyperlink(entity);
	}

	public boolean hasHyperlinks()
	{
		return this.categoryChartHyperlinkProvider.hasHyperlinks();
	}
	...
	private void readObject(ObjectInputStream in) throws IOException, ClassNotFoundException
	{
		...
		if (this.categoryChartHyperlinkProvider == null)
		{
			this.categoryChartHyperlinkProvider = new CategoryChartHyperlinkProvider(this.itemHyperlinks);
