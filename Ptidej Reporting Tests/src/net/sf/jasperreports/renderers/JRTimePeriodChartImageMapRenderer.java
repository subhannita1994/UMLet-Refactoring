 ...
 * @version $Id: JRTimePeriodChartImageMapRenderer.java,v 1.1 2008/09/29 16:22:00 guehene Exp $
 */
public class JRTimePeriodChartImageMapRenderer extends JRAbstractChartImageMapRenderer
{
	...
	{
		return this.timePeriodChartHyperlinkProvider.getEntityHyperlink(entity);
	}
