 ...
 */
class MyDirectedGraphWeakImpl extends GraphDelegator implements DirectedGraph,
		GraphListener {

	private static final long serialVersionUID = -2718883367961089045L;
	...
	private class DirectedVertexData implements Serializable {
		private static final long serialVersionUID = 1871365392604156628L;
		...
		public final List getUnmodifiableIncomingEdges() {
			if (this.unmodifiableIncomingEdges == null) {
				this.unmodifiableIncomingEdges =
					Collections.unmodifiableList(this.incomingEdges);
			}
		...
		public final List getUnmodifiableOutgoingEdges() {
			if (this.unmodifiableOutgoingEdges == null) {
				this.unmodifiableOutgoingEdges =
					Collections.unmodifiableList(this.outgoingEdges);
			}
			return this.unmodifiableOutgoingEdges;
		}
	}

	// private TreeMap vertexDataMap;
	private Map vertexDataMap;

	/**
	 * Creates a new instance of DirectedGraphWeakImpl.
	 */
	public MyDirectedGraphWeakImpl(MyGraphImpl graph) {
		super(graph);
		//vertexDataMap = new TreeMap();
