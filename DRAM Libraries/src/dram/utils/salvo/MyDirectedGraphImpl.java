 ...
 */
public class MyDirectedGraphImpl extends MyGraphImpl implements DirectedGraph {
	private static final long serialVersionUID = -5944583484631799993L;

	/**
	* Delegate object to handle the implementation of the DirectedGraph interface.
	*/
	MyDirectedGraphWeakImpl graphDirectionDelegate;
