...
import ptidej.reporting.charttyped.occurrence.ExplainedDesignSmell;
...
public class ExplainedDesignSmellsDataSource implements JRDataSource {
	...
	public Object getFieldValue(final JRField field) throws JRException {
		...
		else if (fieldName.equals("DesignSmellConfidence")) {
			value =
				String.valueOf(this.explainedDesignSmells[this.index]
					.getConfidence());
		}
