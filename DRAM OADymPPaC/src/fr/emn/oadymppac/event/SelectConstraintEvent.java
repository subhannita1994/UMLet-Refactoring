/*
 * $Id: SelectConstraintEvent.java,v 1.1 2004/03/01 15:37:17 guehene Exp $
 *
...
public class SelectConstraintEvent extends SolverEvent {
	State state;

	public static final short EVENT_TYPE =
		SolverConstants.EVENT_SELECT_CONSTRAINT;

	public SelectConstraintEvent() {
	}
	public SelectConstraintEvent(
		final int n,
		final long time,
	...
	public SelectConstraintEvent(final int n, final long time, final State s) {
		super(n, time, EventAttributes.DEPTH_NONE, null, null, null, null, null);
		this.state = s;
	}
	public SelectConstraintEvent(final int n, final State s) {
		super(n, 0, EventAttributes.DEPTH_NONE, null, null, null, null, null);
		this.state = s;
	}
	public SelectConstraintEvent(
		final SelectConstraintEvent other,
		final boolean deep) {
		super(other, deep);
	...
	public BasicSolverEvent deepClone() {
		return new SelectConstraintEvent(this, true);
	}

	public int getEventType() {
		return SelectConstraintEvent.EVENT_TYPE;
	}
