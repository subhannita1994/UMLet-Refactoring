/*
 * $Id: DeactivateEvent.java,v 1.1 2004/03/01 15:37:17 guehene Exp $
 *
...
public class DeactivateEvent extends SolverEvent {
	State state;

	public static final short EVENT_TYPE = SolverConstants.EVENT_DEACTIVATE;

	public DeactivateEvent() {
	}
	public DeactivateEvent(final DeactivateEvent other, final boolean deep) {
		super(other, deep);
	...
	public DeactivateEvent(final int n, final long time, final State s) {
		super(n, time, EventAttributes.DEPTH_NONE, null, null, null, null, null);
		this.state = s;
	}
	public DeactivateEvent(final int n, final State s) {
		super(n, 0, EventAttributes.DEPTH_NONE, null, null, null, null, null);
		this.state = s;
	}

	public BasicSolverEvent deepClone() {
		return new DeactivateEvent(this, true);
	}

	public int getEventType() {
		return DeactivateEvent.EVENT_TYPE;
	}
